CREATE TYPE "private"."water_tanker_request_list_group" AS ENUM('A', 'B', 'C', 'D', 'E', 'F', 'G');--> statement-breakpoint
DROP VIEW "private"."v_water_tanker_request";--> statement-breakpoint
ALTER TABLE "private"."water_tanker_request" ADD COLUMN "group" "private"."water_tanker_request_list_group";--> statement-breakpoint
UPDATE "private"."water_tanker_request" SET "group" = 'A'::"private"."water_tanker_request_list_group"; --> statement-breakpoint
ALTER TABLE "private"."water_tanker_request" ALTER COLUMN "group" SET NOT NULL; --> statement-breakpoint
